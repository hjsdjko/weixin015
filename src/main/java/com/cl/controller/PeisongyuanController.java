...
public class PeisongyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		PeisongyuanEntity u = peisongyuanService.selectOne(new EntityWrapper<PeisongyuanEntity>().eq("peisongyuanzhanghao", username));
    ...
    public R register(@RequestBody PeisongyuanEntity peisongyuan){
    	...
    	PeisongyuanEntity u = peisongyuanService.selectOne(new EntityWrapper<PeisongyuanEntity>().eq("peisongyuanzhanghao", peisongyuan.getPeisongyuanzhanghao()));
		if(u!=null) {
